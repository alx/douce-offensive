...
* Find YAPB plugins via [http://johannes.jarolim.com/yapb/plugins](http://johannes.jarolim.com/yapb/plugins "The YAPB Plugin Overview")

= Plugins i currently know of =

* XP Uploader [http://wordpress.org/extend/plugins/xp-uploader](http://wordpress.org/extend/plugins/xp-uploader)
* YAPB Sidebar Widget [http://wordpress.org/extend/plugins/yapb-sidebar-widget](http://wordpress.org/extend/plugins/yapb-sidebar-widget)
* YAPB XMLRPC Server [http://wordpress.org/extend/plugins/yapb-xmlrpc-server](http://wordpress.org/extend/plugins/yapb-xmlrpc-server)

= Translations i currently know of =

* German: Included.
* French: [http://www.aurelienpaulus.net/yet-another-photoblog-traduit-en-francais/](http://www.aurelienpaulus.net/yet-another-photoblog-traduit-en-francais/)
* Ukrainian: [http://kosivart.if.ua/2008/10/07/502/](http://kosivart.if.ua/2008/10/07/502/)
* Russian: [http://kosivart.if.ua/2008/10/09/515/](http://kosivart.if.ua/2008/10/09/515/)
...
* Migration of the YAPB Sidebar Widget to it's own plugin: [http://www.wordpress.org/extend/plugins/yapb-sidebar-widget](http://www.wordpress.org/extend/plugins/yapb-sidebar-widget)
